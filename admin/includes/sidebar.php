<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="admin-panel.php" target="_blank">
        <h4>Traveller</h4>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link  active" href="admin-panel.php">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="users.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fa fa-users text-dark text-lg" aria-hidden="true"></i>
            </div>
    ...
    <div class="sidenav-footer mx-3 ">
      ...
      <a class="btn bg-gradient-primary mt-3 w-100" href="admin-login.php">Logout</a>
    </div>
  </aside>